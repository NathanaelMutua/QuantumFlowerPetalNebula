...
export function RoomsPage() {
  ...
  const rooms = [
    ...
    },
    {
      ...
      description:
        "Luxurious suite with separate living area and premium features",
      price: "KES 12,000",
      guests: "3 Adults",
    ...
    },
    {
      title: "Family Room",
      description:
        "Perfect for families with children, spacious and comfortable",
      price: "KES 10,000",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-center text-gray-600 mt-6 text-sm">
              Early check-in and late check-out available upon request (subject
              to availability)
            </p>
          </div>
        </div>
